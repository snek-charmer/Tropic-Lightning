...
const connectorsCollection = "weather_connectors"

// Store persists weather connector configs so the poller (and a fresh node)
// know what to fetch. Backed by peat (source of truth) or an in-memory fake.
